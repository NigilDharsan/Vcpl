...
class Add_ToolsAndPlant_Transaction_Screen extends StatefulWidget {
  const Add_ToolsAndPlant_Transaction_Screen({super.key});

  @override
  State<Add_ToolsAndPlant_Transaction_Screen> createState() => _Add_ToolsAndPlant_Transaction_ScreenState();
}

class _Add_ToolsAndPlant_Transaction_ScreenState extends State<Add_ToolsAndPlant_Transaction_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: Custom_AppBar(title: "Add ToolsandPlants Transactions", actions: null, isBlue: true, isNav: true),
