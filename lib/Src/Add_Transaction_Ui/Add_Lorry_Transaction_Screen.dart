...
class Add_Lorry_Transaction_Screen extends StatefulWidget {
  const Add_Lorry_Transaction_Screen({super.key});

  @override
  State<Add_Lorry_Transaction_Screen> createState() => _Add_Lorry_Transaction_ScreenState();
}

class _Add_Lorry_Transaction_ScreenState extends State<Add_Lorry_Transaction_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: Custom_AppBar(title: "Add Lorry Transactions", actions: null, isBlue: true, isNav: true),
          ...
          child: Column(
            children: [
              ...
              Column(
                children: [
                  // Site Name
                  trnsactionType == "Transfer lorry Items"?  Title_Style(Title: 'To Site Name  ', isStatus: true):Container(),
                  trnsactionType == "Transfer lorry Items"?dropDownField(
                    context,
                  ...
                  //SLIP NUMBER
                  trnsactionType == "Transfer lorry Items"?Title_Style(Title: 'Transfer Slip Number  ', isStatus: true):Container(),
                  trnsactionType == "Transfer lorry Items"?textFormField2(
                    // isEnabled: false,
                  ...
                  //VECHILE NUMBER
                  trnsactionType == "Transfer lorry Items"?Title_Style(Title: 'Vehicle No  ', isStatus: true):
                  trnsactionType == "Received lorry Items"?Title_Style(Title: 'Vehicle No  ', isStatus: true):Container(),
                  trnsactionType == "Transfer lorry Items"? dropDownField(
                    context,
                    value: vechileNumber,
                  ...
                  trnsactionType == "Received lorry Items"?dropDownField(
                    context,
                    value: vechileNumber,
                    listValue: vechileNumberOtion,
                    onChanged: (String? newValue) {
              ...
              Column(
                children: [
                  ...
                  //GRADE AND BRAND
                  trnsactionType == "Received lorry Items"?Title_Style(Title: 'Grade and Brand ', isStatus: true):Container(),
                  trnsactionType == "Received lorry Items"?textFormField2(
                    // isEnabled: false,
