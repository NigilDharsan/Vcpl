...
class Add_Cement_Transaction_Screen extends StatefulWidget {
  const Add_Cement_Transaction_Screen({super.key});

  @override
  State<Add_Cement_Transaction_Screen> createState() => _Add_Cement_Transaction_ScreenState();
}

class _Add_Cement_Transaction_ScreenState extends State<Add_Cement_Transaction_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: Custom_AppBar(title: "Add Cement Transactions", actions: null, isBlue: true, isNav: true),
          ...
          child: Column(
            children: [
              ...
              Column(
                children: [
                  //BAGS QUANTITY
                  trnsactionType == null?Container():Title_Style(Title: 'Bags (Quantity) ', isStatus: true),
              ...
              Column(
                children: [
                  // Site Name
                  trnsactionType == "Transfer Cement"?  Title_Style(Title: 'To Site Name  ', isStatus: true):Container(),
                  trnsactionType == "Transfer Cement"?dropDownField(
                    context,
                  ...
                  //SLIP NUMBER
                  trnsactionType == "Transfer Cement"?Title_Style(Title: 'Transfer Slip Number  ', isStatus: true):Container(),
                  trnsactionType == "Transfer Cement"?textFormField2(
                    // isEnabled: false,
                  ...
                  //VECHILE NUMBER
                  trnsactionType == "Transfer Cement"?Title_Style(Title: 'Vehicle No  ', isStatus: true):
                  trnsactionType == "Received Cement"?Title_Style(Title: 'Vehicle No  ', isStatus: true):Container(),
                  trnsactionType == "Transfer Cement"? dropDownField(
                    context,
                    value: vechileNumber,
                  ...
                  trnsactionType == "Received Cement"?dropDownField(
                    context,
                    value: vechileNumber,
                    listValue: vechileNumberOtion,
                    onChanged: (String? newValue) {
              ...
              Column(
                children: [
                  //INVOICE NUMBER
                  trnsactionType == "Received Cement"?Title_Style(Title: 'Invoie Number  ', isStatus: true):Container(),
                  trnsactionType == "Received Cement"? textFormField2(
                    // isEnabled: false,
                  ...
                  //GRADE AND BRAND
                  trnsactionType == "Received Cement"?Title_Style(Title: 'Grade and Brand ', isStatus: true):Container(),
                  trnsactionType == "Received Cement"?textFormField2(
                    // isEnabled: false,
